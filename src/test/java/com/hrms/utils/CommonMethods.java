...
public class CommonMethods extends PageInitializer {
	...
	/**
	 * Methods that accept alerts and catches exception of alert if alert is not present
	 */
	...
	/**
	 * Methods that dismiss alerts and catches exception of alert if alert is not present
	 */
	...
	/**
	 * Methods that gets text of alert and catches exception of alert if alert is not present
	 * @return
	 */
